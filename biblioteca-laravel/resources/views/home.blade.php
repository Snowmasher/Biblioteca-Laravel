                        ...
                        <tbody>
                            @forelse($libros as $libro)
                                <tr>
                                    ...
                                    <td class="border px-4 py-2">{{ $libro->user->name }}</td>
                                    <td class="border px-4 py-2">{{ $libro->titulo }}</td>
                                    <td class="border px-4 py-2">{{ $libro->descripcion }}</td>
                                    <td class="border px-4 py-2">{{ date_format($libro->created_at, "d/m/Y") }}</td>
                                    <td class="border px-4 py-2">{{ date_format($libro->updated_at, "d/m/Y") }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route("libros.destroy", ["libro" => $libro]) }}" class="bg-red-500 hover:bg-red-700 text-black font-bold py-2 px-4 rounded">Eliminar</a>
                                        <!--
                                        <form method="GET" action="{{ route("libros.destroy", ["libro" => $libro]) }}">
                                            <input type="submit" class="bg-red-500 hover:bg-red-700 text-black font-bold py-2 px-4 rounded">Eliminar</a>
                                        </form>
                                        -->
                                    </td>
                                </tr>
